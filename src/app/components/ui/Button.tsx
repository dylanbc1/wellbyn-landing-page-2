...
export default function Button({
  ...
  return (
    <button
      ...
      className={twMerge(
        clsx(
          "cursor-pointer w-fit rounded-full py-3 px-6 flex items-center gap-2 transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg font-medium text-sm",
          {
