...
export const WobbleCard = ({
  ...
  return (
    <motion.section
      ...
      className={cn(
        "mx-auto w-full bg-[#5FA9DF] relative rounded-2xl overflow-hidden",
        containerClassName
      )}
    >
      <div
        ...
        style={{
          boxShadow:
            "0 10px 32px rgba(95, 169, 223, 0.15), 0 1px 1px rgba(0, 0, 0, 0.05), 0 0 0 1px rgba(95, 169, 223, 0.1), 0 4px 6px rgba(95, 169, 223, 0.1), 0 24px 108px rgba(95, 169, 223, 0.15)",
        }}
      >
        <motion.div
          style={{
